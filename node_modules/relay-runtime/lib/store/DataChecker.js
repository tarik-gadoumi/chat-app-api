...
function () {
  function DataChecker(source, target, variables, handlers, operationLoader, getDataID) {
    ...
    this._mutator = new RelayRecordSourceMutator(source, target, connectionEvents);
    !(connectionEvents.length === 0) ? process.env.NODE_ENV !== "production" ? invariant(false, 'DataChecker: Unexpected connection events.') : invariant(false) : void 0;

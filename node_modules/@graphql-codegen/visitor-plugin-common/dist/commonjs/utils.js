...
function mergeSelectionSets(selectionSet1, selectionSet2) {
    ...
    for (const selection2 of selectionSet2.selections) {
        ...
        const match = newSelections.find(selection1 => selection1.kind === 'Field' && exports.getFieldNodeNameValue(selection1) === exports.getFieldNodeNameValue(selection2));
        if (match) {
...
exports.getFieldNodeNameValue = (node) => {
...
function getPossibleTypes(schema, type) {
    if (graphql_2.isListType(type) || graphql_1.isNonNullType(type)) {
        return getPossibleTypes(schema, type.ofType);
    }
    else if (graphql_1.isObjectType(type)) {
        return [type];
    }
    else if (graphql_3.isAbstractType(type)) {

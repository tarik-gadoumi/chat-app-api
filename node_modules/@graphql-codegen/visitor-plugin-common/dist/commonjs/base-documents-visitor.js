...
class BaseDocumentsVisitor extends base_visitor_1.BaseVisitor {
    constructor(rawConfig, additionalConfig, _schema, defaultScalars = scalars_1.DEFAULT_SCALARS) {
        super(rawConfig, {
            exportFragmentSpreadSubTypes: utils_1.getConfigValue(rawConfig.exportFragmentSpreadSubTypes, false),
            ...
            namespacedImportName: utils_1.getConfigValue(rawConfig.namespacedImportName, null),

...
import { Kind, isScalarType, isEqualType, isNonNullType, isObjectType, } from 'graphql';
...
export function buildScalars(schema, scalarsMapping, defaultScalarsMapping = DEFAULT_SCALARS) {
    let result = {};
